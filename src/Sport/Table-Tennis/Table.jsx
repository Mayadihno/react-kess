...
const image =
  "https://eurogames2022.eu/wp-content/uploads/2020/11/Icoon-Tafeltennis-1-176x176.png";
const Table = () => {
    ...
    <React.Fragment>
      <div className="sport">
        <div className="sport__card">
          <Card maxW={"sm"}>
            <CardHeader>
              <h2 style={{ textAlign: "center" }}>Table Tennis</h2>
            </CardHeader>
            <div className="image">
              <img src={image} />
            </div>
