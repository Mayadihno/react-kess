...
const image =
  "https://eurogames2022.eu/wp-content/uploads/2021/06/icoon-martial-arts-1-176x176.png";
const Martial = () => {
    ...
    <React.Fragment>
      <div className="sport">
        <div className="sport__card">
          <Card maxW={"sm"}>
            <CardHeader>
              <h2 style={{ textAlign: "center" }}>Martial arts</h2>
            </CardHeader>
            <div className="image">
              <img src={image} />
            </div>
