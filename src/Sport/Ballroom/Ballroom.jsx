...
const image =
  "https://eurogames2022.eu/wp-content/uploads/2020/11/Icoon-Stijldansen-1-176x176.png";
const Ballroom = () => {
  ...
  const getCategories = async () => {
    ...
    const q = query(
      collectionRef,
      where("categories", "==", "Ballroom dancing"),
      orderBy("id", "desc")
    );
    ...
    <React.Fragment>
      <div className="sport">
        <div className="sport__card">
          <Card maxW={"sm"}>
            <CardHeader>
              <h2 style={{ textAlign: "center" }}>Ballroom Dancing</h2>
            </CardHeader>
            <div className="image">
              <img src={image} />
            </div>
